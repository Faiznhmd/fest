...
const Sponsers = () => {
  return (
    <main className="relative h-200 flex flex-col justify-center bg-dark-900 overflow-hidden">
      <h1 className="font-bold  text-4xl md:text-6xl my-4 justify-center items-center flex  bg-gradient-to-r from-blue-600 via-purple-300 to-purple-600  text-transparent bg-clip-text pb-5">
