...
export const About = () => {
  return (
    <div className="relative mx-auto py-30 md:flex-row md:py-10 px-4 lg:px-16 w-full flex flex-col justify-between gap-10 md:gap-40">
      <div>
      ...
      <div>
        <Image src="/assets/about.jpg" alt="" width={300} height={700} />
      </div>
    </div>
  );
};
