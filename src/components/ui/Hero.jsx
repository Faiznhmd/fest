...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-30 px-4 w-full  left-0 top-0  items-center flex justify-center flex-col">
      ...
      <h1 className="text-6xl md:text-8xl font-bold text-center bg-gradient-to-r from-blue-600 via-purple-300 to-purple-600 inline-block text-transparent bg-clip-text">
        Tech Udbhav <span className='font-medium'>By</span> IETE SF
      </h1>
